...
class BlurWeight(bpy.types.Operator):
	...
	mode = bpy.props.EnumProperty(items=items, name="Mode", default='ACTIVE')
	blur_count = bpy.props.IntProperty(name="Blur Count", default=10, min=1, max=100, soft_min=1, soft_max=100, step=1)
	use_clean = bpy.props.BoolProperty(name="Use Clean", default=True)
