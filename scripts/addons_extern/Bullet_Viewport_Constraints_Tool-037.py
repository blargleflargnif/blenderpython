...
def update(objs):
    ...
    def up_rigid_constraint():
        ...
        if wm.bullet_tool.bullet_tool_show_it == True:    
            orbc.override_solver_iterations = wm.bullet_tool.bullet_tool_over_iteration
            oorbc.num_solver_iterations = wm.bullet_tool.bullet_tool_iteration
...
class OBJECT_OT_Bullet_Ground_connect(bpy.types.Operator):
    ...
    def execute(self, context):   
        ...
        context.scene.objects.active = ground #del bpy
        objs.remove(ground)
