...
<Settings xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" Version="3.18.1">""")
            ...
            lowpoly = export_path + '\\' + scene.xN_lowpoly + '.obj'
            hipoly = export_path + '\\' + scene.xN_hipoly + '.obj'
  ...
  int(scene.xN_derivative_bgcolor[2]*255))) 
    ...
    <LightPosition x="-34.639999" y="340.609985" z="104.209999"/>
        ...
        objs_to_export = [scene.xN_hipoly, scene.xN_lowpoly]
        
#        for object in bpy.context.selected_objects:
#            objs_to_export.append(object.name)
        ...
        for obj_name in objs_to_export:
            ...
            obj_export_name = export_path + '\\' + obj_name + '.obj'
...
class PROPERTIES_PT_xN_ExportPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(scene, 'xN_discard_BF')
