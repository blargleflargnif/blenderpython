...
if ikbrushexist == False:  
    filepath = str(bpy.utils.script_path_user()) + "\\addons_extern\\sculpt_brushes\\Brushes_IK.blend"
    #Load IK Brushes 
...
def execscript():
    lien = str(bpy.utils.script_path_user()) + "\\addons_extern\\sculpt_brushes\\main_brush.py"
