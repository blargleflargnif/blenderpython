...
# view3d_advanced_dynamic_spacebar_menu byBrendon Murphy (meta-androcto)
bl_info = {
    "name": "Advanced Context Menu",
    "author": "meta-androcto",
    "version": (3, 0, 0),
    "blender": (2, 7, 1),
    "location": "View3D > Spacebar Key, Advanced Tab, Info Header",
...
class INFO_MT_add_menu(bpy.types.Menu):
    bl_label = "Advanced Menu"
    bl_space_type = 'INFO'
...
def menu_func(self, context):
    self.layout.menu("INFO_MT_add_menu")
...
class VIEW3D_MT_Space_Dynamic_Menu(bpy.types.Menu):
    bl_label = "Advanced Spacebar Menu"
...
def register():
    bpy.types.INFO_HT_header.prepend(menu_func)
