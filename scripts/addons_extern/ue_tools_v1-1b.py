...
bl_info = {
    ...
    "version": (1, 1),
    "blender": (2, 7, 2),
    "location": "View3D > Tools > UE Tools",
...
"""# Grab values From Props
def Set_ObjScale(label, key, scn):        
    global ObjScale     
    ObjScale = scn["UEObjScale"]"""
...
def FBX_Format_Callback  (scene,context):    
    ...
    print ("Base name = " + str(FBX_Format))    
...
def FBX_Export(self,context):    
    ...
    bpy.ops.export_scene.fbx(check_existing=True,
                             ...
                             mesh_smooth_type=FBX_SmothingType, 
...
class UEScaleOperator(bpy.types.Operator):
    ...
    def execute (self, context):
        ...
        """#Grab values for props
        Set_ObjScale("Bool:   ", 'UEObjScale', scn) """     
...
class Mainpanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if Init == False:
            ...
            col.operator ( "ue.init_button", text= "Open UE Tools",icon='VISIBLE_IPO_ON')
