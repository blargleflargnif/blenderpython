...
class VIEW3D_PT_advanced_menu(bpy.types.Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'TOOLS'
    bl_category = "Dynamic"
    bl_label = "Dynamic Drop"
    ...
    def draw(self, context):
        ...
        layout.menu("VIEW3D_MT_Space_Dynamic_Menu", text="Context Menu", icon='PLUGIN')

class VIEW3D_PT_advanced1_menu(bpy.types.Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'TOOLS'
    bl_category = "Dynamic"
